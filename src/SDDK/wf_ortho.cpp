...
/// Orthogonalize n new wave-functions to the N old wave-functions
    ...
    static void orthogonalize(memory_t mem__,
                              linalg_t la__,
                              int ispn__,
        ...
        if (N__ > 0) {
            ...
            ::sddk::transform(mem__, la__, ispn__, -1.0, wfs__, 0, N__, o__, 0, 0, 1.0, wfs__, N__, n__);
...
//#endif
    ...
    void orthogonalize(memory_t mem__,
        ...
        orthogonalize<double, 0, 0>(mem__, la__, ispn__, wfs, N__, n__, o__, tmp__);
    }
    ...
    void orthogonalize(memory_t mem__,
        ...
        orthogonalize<double_complex, 0, 0>(mem__, la__, ispn__, wfs, N__, n__, o__, tmp__);
    }
    ...
    void orthogonalize(memory_t mem__,
        ...
        orthogonalize<double, 0, 2>(mem__, la__, ispn__, wfs, N__, n__, o__, tmp__);
    }
    ...
    void orthogonalize(memory_t mem__,
        ...
        orthogonalize<double_complex, 0, 2>(mem__, la__, ispn__, wfs, N__, n__, o__, tmp__);
    }
}
