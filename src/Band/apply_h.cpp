...
template void Band::apply_h<double_complex>(K_point* kp__, 
                                            int ispn__,
                                            int N__,
                                            int n__,
                                            Wave_functions<false>& phi__,
                                            Wave_functions<false>& hphi__,
                                            Hloc_operator& h_op,
                                            D_operator<double_complex>& d_op) const;

template void Band::apply_h<double>(K_point* kp__, 
                                    int ispn__,
                                    int N__,
                                    int n__,
                                    Wave_functions<false>& phi__,
