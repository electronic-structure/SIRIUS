...
void Density::reduce_density_matrix(Atom_type const& atom_type, int ialoc, mdarray<double_complex, 4>& zdens, mdarray<double, 3>& mt_density_matrix)
{
...
template void Density::reduce_density_matrix<0>(Atom_type const& atom_type, int ialoc, mdarray<double_complex, 4>& zdens, mdarray<double, 3>& mt_density_matrix);
template void Density::reduce_density_matrix<1>(Atom_type const& atom_type, int ialoc, mdarray<double_complex, 4>& zdens, mdarray<double, 3>& mt_density_matrix);
template void Density::reduce_density_matrix<3>(Atom_type const& atom_type, int ialoc, mdarray<double_complex, 4>& zdens, mdarray<double, 3>& mt_density_matrix);
