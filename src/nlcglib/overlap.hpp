...
class Overlap_operators : public nlcglib::OverlapBase
{
  ...
  public:
    Overlap_operators(const K_point_set& kset, const Simulation_context& ctx, const Q_operator<double>& q_op);
...
template<class op_t>
Overlap_operators<op_t>::Overlap_operators(const K_point_set& kset, const Simulation_context& ctx, const Q_operator<double>& q_op)
{
