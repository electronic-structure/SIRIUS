...
void AtomSymmetryClass::generate_lo_radial_functions()
{
    int nmtp = atom_type_->num_mt_points();
    RadialSolver solver(false, -1.0 * atom_type_->zn(), atom_type_->radial_grid());
...
void AtomSymmetryClass::check_lo_linear_independence()
{
    int nmtp = atom_type_->num_mt_points();
...
void AtomSymmetryClass::dump_lo()
{
    std::stringstream s;
...
void AtomSymmetryClass::transform_radial_functions(bool ort_lo, bool ort_aw)
{
...
void AtomSymmetryClass::set_spherical_potential(std::vector<double>& veff)
{
    int nmtp = atom_type_->num_mt_points();
...
void AtomSymmetryClass::generate_radial_functions(run_time_info& rti__)
{
...
inline void AtomSymmetryClass::sync_radial_functions(int rank)
{
...
inline void AtomSymmetryClass::sync_radial_integrals(int rank)
{
...
void AtomSymmetryClass::generate_radial_integrals()
{
...
void AtomSymmetryClass::generate_core_charge_density()
{
...
inline void AtomSymmetryClass::sync_core_charge_density(int rank)
{
