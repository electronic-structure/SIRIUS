...
PYBIND11_MODULE(py_sirius, m)
{
    ...
    py::class_<Unit_cell>(m, "Unit_cell")
            ...
            .def_property_readonly("augmented", &Unit_cell::has_augmented_atom)
    ...
    m.def("ks_energy",
          py::overload_cast<Simulation_context const&, K_point_set const&, Density const&, Potential const&, double>(
                  &ks_energy));
