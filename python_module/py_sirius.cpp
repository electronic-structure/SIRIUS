...
PYBIND11_MODULE(py_sirius, m)
{
    ...
    //                  buffer << "\t atom ia = " << ia << " ";
    //                  buffer << "\t nbf     : " << std::setw(10) << obj.desc_(static_cast<int>(beta_desc_idx::nbf),
    //                  ia)
    //                         << " ";
    ...
    //     .def_readonly("a", &beta_projectors_coeffs_t<double>::pw_coeffs_a,
    //     py::return_value_policy::reference_internal) .def_readonly("chunk",
    //     &beta_projectors_coeffs_t<double>::beta_chunk, py::return_value_policy::reference_internal);

    // py::class_<Beta_projector_generator<double>>(m, "Beta_projector_generator")
    //     .def("generate", py::overload_cast<beta_projectors_coeffs_t<double>&,
    //     int>(&Beta_projector_generator<double>::generate, py::const_)) .def("generate_j",
    //     py::overload_cast<beta_projectors_coeffs_t<double>&, int, int>(&Beta_projector_generator<double>::generate,
    //     py::const_));
    ...
    //     .def("make_generator", py::overload_cast<>(&Beta_projectors_base<double>::make_generator, py::const_),
    //     py::keep_alive<1, 0>());
...
void
apply_hamiltonian(Hamiltonian0<double>& H0, K_point<double>& kp, Wave_functions<double>& wf_out,
                  Wave_functions<double>& wf, std::shared_ptr<Wave_functions<double>>& swf)
{
    /////////////////////////////////////////////////////////////
