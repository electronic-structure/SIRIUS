    ...
    switch (task_id) {
        ...
        case task_t::ground_state_restart: {
            ...
            for (int i = 0; i < 200; i++) {
                ...
                auto val = get_wave_function_value(rc, dft.k_point_set().get<double>(0)->spinor_wave_functions(), dft.ctx().unit_cell(),
                        *dft.k_point_set().get<double>(0));
