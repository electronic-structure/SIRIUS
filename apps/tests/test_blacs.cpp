...
int main(int argn, char** argv)
{
    ...
    auto blacs_handler = sddk::linalg_base::create_blacs_handler(mpi::Communicator::self().native());
    blacs_handler = sddk::linalg_base::create_blacs_handler(mpi::Communicator::world().native());
