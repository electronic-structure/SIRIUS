               ...
               int num_fft_streams__, int num_threads_fft__, int use_gpu, double gpu_workload__)
{
    ...
    Wave_functions phi(4 * num_bands__, gvec, mpi_grid, static_cast<processing_unit_t>(use_gpu));
    ...
    Wave_functions hphi(4 * num_bands__, num_bands__, gvec, mpi_grid, static_cast<processing_unit_t>(use_gpu));
